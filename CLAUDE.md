...
The specs are the reference layer. For specific recurring tasks — publishing a work, adding a component, auditing the canaries — there are task-oriented skills in [`.claude/skills/`](./.claude/skills/) that walk the spec graph on your behalf. Skills are thin and action-shaped; specs are dense and reference-shaped. Skills never duplicate spec content; they point back. When a skill and a spec disagree, the spec wins.

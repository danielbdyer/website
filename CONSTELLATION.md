...
~~A held question: does the icon's *form* change as it ascends?~~ **Resolved (2026-09-05, with Danny): yes, and further than a corona.** The celestial form is the small form *grown into its place* — grown a face. In the sky the daystar is a character drawn the way a 1930s picture book draws one: plump and rosy, a bulb of a nose with its highlight, bright eyes under arched brows, a jovial mouth — the register of a mid-century Christmas card's Santa, the faerie-king of noon and the old man in the moon. The sun wears a crown of hand-cut flame rays that turns once every two minutes and twenty; the moon keeps its lit limb, freckles of crater, heavier lids, golden eyes, and three small stars. The face breathes, blinks, turns a degree toward the pointer, and its eyes follow. The physics is a watercolor's: every wash a gradient with a wet rim, the one filter on the still halo behind. *The clay of life with an illusory veneer.* Danny's reference images (a card's Santa; the sun with the sleeping moon at its shoulder) are inspiration, not specification; the outcome is the site's own.

...
- **No drag.** Nothing pulls, drifts, coasts, or demonstrates. The sky moves only toward a named destination; the hand never throws it. (A drag as an *additional* surface is held in [BACKLOG.md](./BACKLOG.md).)

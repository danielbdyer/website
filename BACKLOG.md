...
**Why:** The sixth pass (2026-09-05) made the look-up a lean-back into the heavens and gave the dark hour its gas clouds and its quiet-versus-attended stars; the seventh opened the heavens beyond the sphere by night and nudged the day's sheet toward parchment (`CONSTELLATION.md` §"The Sun and the Moon", *The lift*, *The heavens*). Every angle and color was set once in a headless browser against Danny's memory of a certain skill-sky: the room's drop and tilt, the sky's approach and scale, the clouds' banks and filaments and the sweep that gives them a point of view, the band inside the rim where the sphere's sky and the open sky blend, the parchment's mottle and its edge, the quiet star's paleness and the attended star's gold.

...
**Why:** The daystar became a character on 2026-09-05 (`CONSTELLATION.md` §"The Sun and the Moon") and, the same day, changed register on Danny's self-critique — _less clowny, more illustrated_ — from a card's Santa to the engraver's sun in splendour and the moon asleep in profile, with a scarf of silk swooping around the face in three strands (`CONSTELLATION_STORYBOARD.md` §"The Third Pass"). The crown's cut, the line-work's weight, the grain's density, the crescent's profile, the scarf's width, orbit, flutter, and the four colors of its silk by hour, the glow the pointer lends it and the whirl of the turn — all were drawn once, in a headless browser. Held within it: whether the sun wants a second, inner crown of short rays as the clocks' suns do; whether the scarf wants to trail sparks through the turn; whether the moon's crescent wants to face the sun across the turn; the dissolve's true key frames (the fifth pass built the silk's late crossing, the stretch and blur, the body thinning at the edge, the whirl at the rim — the rays streaming into the strands and the crescent gathering out of them are the next drawing); the half-turn's perspective and timing.
...
### The lift and the heavens, tuned by eye

**Why:** The sixth pass (2026-09-05) made the look-up a lean-back into the heavens and gave the dark hour its gas clouds and its quiet-versus-attended stars; the seventh opened the heavens beyond the sphere by night and nudged the day's sheet toward parchment; the eighth made the look-up the eye turning in a space that stays — the room's surface continuing past the frame, the heavens a dome turned by the same pitch, the descent the same arc in reverse on the same canvas — and retuned the heavens' palette against three Hubble plates (`CONSTELLATION.md` §"The Sun and the Moon", _The lift_, _The heavens_, _The heavens' palette_). Every angle and color was set once in a headless browser against Danny's memory of a certain skill-sky and his three plates: the pitch per unit of reveal and where the lift ends, the 900 ms and its curve, the small depths of the room's chrome and text, the dome's rest pitch, the clouds' haze and rust and ochre and dust and the sweep that gives them a point of view, the band inside the rim where the sphere's sky and the open sky blend, the parchment's mottle and its edge, the quiet star's paleness and the attended star's gold. Two things in the eighth pass are held for Danny's eye in particular: by day the chart pitches with the dome too — the plate rides high in the backdrop and comes down to center as the eye turns — and whether the day should turn at all, or the sheet stay a sheet, is his to feel; and — resolved in the ninth pass and the tenth by the glyph's seat (`CONSTELLATION.md` §"The Sun and the Moon", _The seat_) — the daystar's flight, which had begun below the frame; what remains for the eye is when the character should first show in the sky (now as soon as the page has uncovered its place), the breath of growth the fading glyph keeps, the half second the daystar holds before it comes down, and the turn's two curves.
**Trigger:** Danny's eye on the lived look-up at a phone's size and a wide screen's. Each is a keyframe in `tokens.css` §"The ascent" or a line in `webgl/atmosphereShaders.ts`.

### One substrate

**Why:** Danny's tremor on 2026-09-05 — _the room and the sky as one and the same, already in WebGL mode; travel of the character active in both substrates; maybe the whole site is canvas_ — and his reference, a painting in motion with fish shimmering as they swim. The fourth pass built the seed (`CONSTELLATION.md` §"The Sun and the Moon", _Held — one substrate_): the atmosphere warmed ahead of the look-up, the daystar as the constant of the descent, the body painted as living pigment in a canvas of its own. The smallest next step is the glyph in the nav carrying the daystar's paint, so the character is continuous across the boundary rather than morphed across it; after that, the sky's ground as brushwork in motion — directional strokes, an evolving field. The room's prose stays DOM, and a WebGL context on every page stays refused as weight on arrival.
**Trigger:** Danny's word after living with the painted body and the descent.

### An authored animation layer over the daystar

**Why:** Danny named the destination — _a layer that goes over the top of this magic play dough, animated on the page; Destino and Fantasia; the ultra-detailed sun and moon clocks; maybe Lottie_ — and the third pass built the procedural half: the scarf's geometry and its GSAP driver, in slots the molecule keeps behind and in front of the face. An authored animation (Lottie or Rive, drawn frame by frame or rigged) would go in the same slots, on the same lazy path, under the same gate and budget (`PERFORMANCE_BUDGET.md` §"The Sky's Lazy Layers"); `lottie-web`'s light build is ~40 KB gzipped, `@rive-app/canvas-lite` ~30 KB, and either would be a third lazy layer with its own floor. What it needs that code cannot supply is the drawing itself.
...
**Why:** `DEPENDENCY_POLICY.md` is partially covered in the north star's technology stack table. A full policy would name evaluation criteria, update cadence, and the philosophical stance on third-party code. _2026-09-05:_ GSAP joined as the daystar's lazy layer, on Danny's ask; the guidance that admitted it — lazy, gated by the visitor's preferences, budgeted apart from the eager path, disposable — is written in `PERFORMANCE_BUDGET.md` §"The Sky's Lazy Layers" and is the seed of this policy.
